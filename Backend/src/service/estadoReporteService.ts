...
/** Datos de entrada: el id lo genera la base de datos (identity). */
...
export async function actualizarEstado(id: number, datos: EntradaEstado): Promise<EstadoReporte | null> {
    if (!validarId(id)) throw new Error("ID inválido.");
