...
@Component({
  ...
  template: `
    ...
    <main class="pagina">
      ...
      <h1>Acerca de</h1>
      <p>EcoMuni es la plataforma ciudadana para reportar, dar seguimiento y resolver
         problemas ambientales en los 22 departamentos de Guatemala.</p>
      <p>Registra un reporte desde la vista de tu departamento, adjunta evidencia y
         sigue su estado hasta la solución. También puedes apoyar y comentar los
         reportes de tu comunidad.</p>
